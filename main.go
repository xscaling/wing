...
//go:generate go run generate_plugin_discovery.go
...
func init() {
	...
	utilruntime.Must(wingv1.AddToScheme(scheme))
...
func main() {
	...
	controllerOptions := controllers.NewDefaultOptions()
	controllerOptions.BindFlags(flag.CommandLine)
	flag.Parse()
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "a9bf3adb.xscaling.dev",
